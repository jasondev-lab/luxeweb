					...
					<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							...
							<form class="form" action="{{ route('login') }}" method="post" id="kt_login_signin_form">
								...
								<div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8 @error('password') is-invalid @enderror" type="password" placeholder="Password" name="password" autocomplete="off" />
                                    @error('password')
                                        <span class="invalid-feedback text-uppercase verdana-text" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
								...
								<div class="form-group text-center mt-10">
									<button id="btn_login" class="btn btn-pill btn-primary opacity-90 px-15 py-3">Sign In</button>
								</div>
							</form>							
						</div>
