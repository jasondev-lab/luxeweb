...
jQuery(document).ready(function() {
    ...
    $('#btn_save_description').on('click', function(e){
        ...
        $.ajax({
            ...
            data: {
                _token: "{{ csrf_token() }}",
                meta_key: 'join-directory-description',
                meta_value: JSON.stringify({ title:$('#title').val(), block1:$('#kt_summernote1').summernote('code'), block2:$('#kt_summernote2').summernote('code') })
            },
            dataType: 'json',
