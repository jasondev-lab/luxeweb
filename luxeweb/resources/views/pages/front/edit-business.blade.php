...
<div class="d-flex align-items-baseline mb-10">
    <h1 class="custom-title">Edit Business</h1>
</div>
                ...
                <div class="wizard wizard-1" id="kt_business_add" data-wizard-state="step-first" data-wizard-clickable="true">
                    ...
                    <div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
                        <div class="col-xl-12 col-xxl-9">
                            ...
                            <form class="form" id="kt_business_form" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg form-control-solid" name="name" value="{{ $business['name'] }}" placeholder="Business Name">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="image-input image-input-outline image-input-empty" id="kt_card" style="background-image: url({{ asset('uploads/businesses'.'/'.$business['card']) }})">
                                                        <div class="image-input-wrapper" id="card_img" style="background-image: url({{ asset('uploads/businesses'.'/'.$business['card']) }})"></div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input type="number" class="form-control form-control-lg form-control-solid" name="hours" value="{{ $business['hours'] }}" placeholder="Business Hours">
                                                    </div>
                                                </div>
                                            </div>                                            
                                            <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <input id="tagify_keywords" class="form-control form-control-lg form-control-solid tagify" placeholder="Keywords" value="{{ implode(',', $business['keywords']) }}" autofocus="" data-blacklist='' />
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg form-control-solid" name="address" value="{{ $business['address'] }}" placeholder="Brick and Mortar Address">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg form-control-solid" name="web_address" value="{{ $business['web_address'] }}" placeholder="Website Address">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg form-control-solid" name="phone_number" value="{{ $business['phone_number'] }}" placeholder="Phone Number">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg form-control-solid" name="facebook" value="{{ $business['facebook'] }}" placeholder="Facebook Link">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg form-control-solid" name="twitter" value="{{ $business['twitter'] }}" placeholder="Twitter Link">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-9 col-xl-9">
                                                    <div class="input-group input-group-lg input-group-solid">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg form-control-solid" name="instagram" value="{{ $business['instagram'] }}" placeholder="Instagram Link">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
jQuery(document).ready(function() {
    ...
    $('.state').val(business.state).trigger('change');
    $('#description1').val(business.description);
