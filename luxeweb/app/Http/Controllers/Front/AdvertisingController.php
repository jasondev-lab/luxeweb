...
class AdvertisingController extends Controller
{
    ...
    public function index()
    {
        ...
        $description=Setting::where('meta_key', 'advertising-description')->first();
        ...
        return view('pages.front.advertising', compact('menu', 'side_items', 'description', 'home', 'image_sizes'));
    }
}
